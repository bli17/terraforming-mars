...
export class Recyclon extends CorporationCard {
    ...
    super({
      ...
      metadata: {
        ...
        renderData: CardRenderer.builder((b) => {
          ...
          b.corpBox('effect', (ce) => {
            ce.effect('When you play a building tag, including this, gain 2 microbes (buff: +1) to this card, or remove 2 microbes here and raise your plant production 1 step.', (eb) => {
              eb.tag(Tag.BUILDING).colon().resource(CardResource.MICROBE, {amount: 2, digit}).or();
  ...
  public onCardPlayed(player: IPlayer, card: ICard) {
    ...
    const addResource = new SelectOption('Add two microbe resources to this card', 'Add microbe').andThen(() => {
      player.addResourceTo(this, 2);
      return undefined;
    });
