...
export class UtopiaInvest extends Card implements IActionCard, ICorporationCard {
  constructor() {
    super({
      ...
      metadata: {
        cardNumber: 'R33',
        description: 'You start with 35 (nerf: -5) M€. Increase your steel and titanium production 1 step each.',
        renderData: CardRenderer.builder((b) => {
          b.br;
          b.megacredits(35).nbsp.production((pb) => pb.steel(1).titanium(1));
          b.corpBox('action', (ce) => {
